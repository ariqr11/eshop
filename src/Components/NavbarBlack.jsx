...
const NavbarComponent = (props) => {
    ...
    return (
        <div className='navbar navbar-expand-lg text-dark mb-0'>
                                ...
                                <div>
                                    {
                                        username && status == 'Verified' ?
                                            <div className='d-flex align-items-center'>
                                                <Text className='text-dark me-3' fontStyle='italic'>{status}</Text>
                                                <Menu>
                                                    <MenuButton>
                                            ...
                                            <div className='btn-group'>
                                                <button type='button' className='btn btn-outline-primary border text-dark' onClick={() => navigate('/login')}>Sign In</button>
